        ...
        <select class="form-select changeLang" aria-label="Default select example">
            ...
            <div class="top-navbar-right ms-3">
              ...
              <li class="nav-item dropdown dropdown-large">
                <a class="nav-link dropdown-toggle dropdown-toggle-nocaret" href="{{ url("#") }}" data-bs-toggle="dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                  <li>
                   ...
                   <li>
                      <a class="dropdown-item" href="{{ url("pages-user-profile.html") }}">
                         <div class="d-flex align-items-center">
                    ...
                    <li>
                      <a class="dropdown-item" href="{{ url("index2.html") }}">
                         <div class="d-flex align-items-center">
                    ...
                    <li><hr class="dropdown-divider"></li>
                    <li>
                      <a class="dropdown-item" href="{{ url("authentication-signup-with-header-footer.html") }}">
                         <div class="d-flex align-items-center">
              ...
              <li class="nav-item dropdown dropdown-large">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                   <div class="row row-cols-3 gx-2">
                      <div class="col">
                        <a href="{{ url("ecommerce-orders.html") }}">
                     ...
                     <div class="col">
                      <a href="{{ url("ecommerce-products-grid.html") }}">
                      <div class="apps p-2 radius-10 text-center">
                    ...
                    <div class="col">
                      <a href="{{ url("component-media-object.html") }}">
                      <div class="apps p-2 radius-10 text-center">
                    ...
                    <div class="col">
                      <a href="{{ url("pages-user-profile.html") }}">
                      <div class="apps p-2 radius-10 text-center">
                    ...
                    <div class="col">
                      <a href="{{ url("ecommerce-orders-detail.html") }}">
                      <div class="apps p-2 radius-10 text-center">
                ...
                <div class="dropdown-menu dropdown-menu-end p-0">
                 ...
                 <div class="header-message-list p-2">
                    <div class="dropdown-item bg-light radius-10 mb-1">
                     ...
                     <a class="dropdown-item" href="{{ url("#") }}">
                       <div class="d-flex align-items-center">
                          <img src="{{ asset("assets/images/avatars/avatar-1.png") }}" alt="" class="rounded-circle" width="52" height="52">
                    ...
                    <a class="dropdown-item" href="{{ url("#") }}">
                      <div class="d-flex align-items-center">
                         <img src="{{ asset("assets/images/avatars/avatar-2.png") }}" alt="" class="rounded-circle" width="52" height="52">
                         <div class="ms-3 flex-grow-1">
                    ...
                    <a class="dropdown-item" href="{{ url("#") }}">
                      <div class="d-flex align-items-center">
                         <img src="{{ asset("assets/images/avatars/avatar-3.png") }}" alt="" class="rounded-circle" width="52" height="52">
                         <div class="ms-3 flex-grow-1">
                    ...
                    <a class="dropdown-item" href="{{ url("#") }}">
                      <div class="d-flex align-items-center">
                         <img src="{{ asset("assets/images/avatars/avatar-4.png") }}" alt="" class="rounded-circle" width="52" height="52">
                         <div class="ms-3 flex-grow-1">
                    ...
                    <a class="dropdown-item" href="{{ url("#") }}">
                      <div class="d-flex align-items-center">
                         <img src="{{ asset("assets/images/avatars/avatar-5.png") }}" alt="" class="rounded-circle" width="52" height="52">
                         <div class="ms-3 flex-grow-1">
                    ...
                    <a class="dropdown-item" href="{{ url("#") }}">
                      <div class="d-flex align-items-center">
                         <img src="{{ asset("assets/images/avatars/avatar-6.png") }}" alt="" class="rounded-circle" width="52" height="52">
                         <div class="ms-3 flex-grow-1">
